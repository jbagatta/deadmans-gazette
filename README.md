...
*NOTE: The code provided in this repository is a proof-of-concept sandbox ONLY. It is a work in progress, and should **not** be considered secure, or even fully functional. While I am doing my best, I am quite frankly **not** good enough at this to be the solely-responsible security engineer for a project like this in my spare time. **PLEASE DO NOT USE THIS CODE AS-IS**.*
